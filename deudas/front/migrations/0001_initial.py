...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'front_cliente', (
            ...
            ('mensualidad', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table(u'front_ingreso', (
            ...
            ('glosa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['front.Glosa'], blank=True)),
    ...
    models = {
        ...
        u'front.ingreso': {
            ...
            'glosa': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['front.Glosa']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
