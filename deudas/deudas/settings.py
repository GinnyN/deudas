"""
Django settings for deudas project.
...
SECRET_KEY = '=n-#7_#g%6*41g1a0)achk#=3-0&yjig(3zp-12=3*(jbn0u-3'
...
ROOT_URLCONF = 'deudas.urls'

WSGI_APPLICATION = 'deudas.wsgi.application'
